...
//	key := "479dff38f63417579564cc18fdf12d20c561d0fc73765dcccf949a052e4d923701"
...
//	privateKey := "479dff38f63417579564cc18fdf12d20c561d0fc73765dcccf949a052e4d923701"
//	postConditionMode := 2
...
//}
//思路：
//	1.检查出块情况---api来自btcq api：https://mempool.space/api/blocks/tip/height
//	2.检查swap情况
//	3.整合TX
//	4.签名广播交易
//	5.手续费监控
...
// 检查出块情况
// 创建交易，广播交易，签名
func TestReplicateTransaction1(t *testing.T) {
	// 设置交易参数
	...
	nonce := big.NewInt(130)                                       // nonce
	fee := big.NewInt(1002)                                        // 手续费 0.001002
	...
	functionArgs := []stx.ClarityValue{
		...
		stx.NewUintCV(big.NewInt(70000)),     // dx
		&stx.SomeCV{stx.OptionalSome, stx.NewUintCV(big.NewInt(672000000))}, // 使用指针类型的 min-dy
	}
